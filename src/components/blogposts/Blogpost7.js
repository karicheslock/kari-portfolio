        ...
        <div className="container flex flex-col justify-center max-w-4xl m-auto bg-neutral-50 text-stone-600 p-10">
            ...
            <div className="flex mb-4">
                ...
                <div className="flex justify-between">
                    ...
                    <img src="../images/blogpost7-code.jpg" alt='Some code on a computer screen' className="w-2/3 h-48 rounded pl-20"></img>
                </div>
            ...
            <p className="mb-5 leading-7">The last thing we need to do is edit the rules for our database.  Click on the Rules tab in the upper left of the screen and then change the read,write rule from false to what is shown below.  Be sure to click Publish when you are done.</p>
